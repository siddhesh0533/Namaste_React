        ...
        <div>
            <div className="flex items-center gap-2.5 p-5 ">
                <div className="flex items-center">
                    ...
                    <button className="m-1 p-2.5 bg-black text-white" onClick={()=>{const filterResto = originalRestro.filter((res)=>res.info.name.toLowerCase().includes(searchtext.toLowerCase()));
